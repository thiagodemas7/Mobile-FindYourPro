...
oauthApp.controller('welcomeCtrl', function ($scope, $state, $cookieStore) {
    ...
    $scope.gplusLogin = function () {
        var myParams = {
            ...
            'clientid': '231698228593-v9pcpmr5b3gmjubid6trjg4o2eh7t6cf.apps.googleusercontent.com',
...
oauthApp.controller('dashboardCtrl', function ($scope, $window, $state, $cookieStore, $http) {
    // Set user details
    $scope.result = "";
...
oauthApp.controller('MapCtrl', function($scope, $state, $cordovaGeolocation){
